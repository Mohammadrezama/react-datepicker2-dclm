...
export class Calendar extends Component {
  ...
  state = {
    year: this.props.defaultYear || this.props.selectedDay || momentJalaali(),
    month: this.props.defaultMonth || this.props.selectedDay || momentJalaali(),
  ...
  renderDays = () => {
    ...
    const currentDay = momentJalaali();
      ...
      <div className={this.props.calendarClass}>
        ...
        <div className={styles.dayPickerContainer}>
          {days.map(day => {
            ...
            const disabled =
              (min || disablePast ? day.isBefore(disablePast ? currentDay : min, 'day') : false) ||
              (max || disableFuture ? day.isAfter(disableFuture ? currentDay : max, 'day') : false);
